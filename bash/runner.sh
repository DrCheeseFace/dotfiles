...
# command='   python3 wine.py'
# command='   python3 part_1.py'
# command='   python3 part_2.py'
command='   python3 part3coursework.py'
# command='   python3 singledim.py'
# command='   python3 biplots.py'
# command='   python3 kmean.py'
